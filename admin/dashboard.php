...
<?php include("includes/header.php");?>
	...
	<div class="ts-main-content costm">
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-primary text-light">
												<div class="stat-panel text-center round_box">
...
?>
											...
											<a href="manage-student.php" class="block-anchor panel-footer">Full Detail <i class="fa fa-arrow-right"></i></a>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-success text-light">
												<div class="stat-panel text-center round_box">
<?php
$result1 ="SELECT  count(distinct room_id) FROM room ";
...
?>
									...
									<div class="col-md-3">
										<div class="panel panel-default">
											<div class="panel-body bk-info text-light round_box">
												<div class="stat-panel text-center">
																		<?php
																		$result2 ="SELECT count(*) FROM employee ";
