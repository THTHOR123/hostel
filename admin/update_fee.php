...
$id = $_GET['id'];
    ...
    $query = "select * from fee where usn = '$id'";
...
if($_POST['update'])
{
   ...
   $query = "update fee set usn = '$usn' , status = '$status'  ,transaction_id = '$transaction' ,date='$date' where usn = '$id'";
    $data = mysqli_query($mysqli,$query);
...
<div class="col-sm-8">
<input type="text" value="<?php echo $result['status'] ;?> " name="status" id="fname"  class="form-control" required="required" >
</div>
</div>
...
<div class="col-sm-8">
<input type="text" value="<?php echo $result['transaction_id']  ;?> " name="transaction" id="name"  class="form-control">
</div>
</div>
...
<div class="col-sm-8">
<input type="date" value="<?php echo $result['date']  ;?> " name="date" id="lname"  class="form-control" required="required">
</div>
</div>
